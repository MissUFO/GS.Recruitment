CREATE PROCEDURE [process].[Assignments_Get]
				 @Id UNIQUEIDENTIFIER
				,@Xml XML OUTPUT
AS
BEGIN
	...
	SET @Xml =  (SELECT(SELECT	 
						...
						,(SELECT task.Id
						  ...
						  ,(SELECT(SELECT
							...
							FOR XML RAW('AssignmentContact'), TYPE)
						FOR XML PATH('AssignmentContacts'),TYPE)
